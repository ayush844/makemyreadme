...
const Features = () => {
	return (
		<div id="features">
			<Container>
				<motion.div
					className="md:w-2/3 lg:w-3/5 mt-24"
...
const featureData = [
	{
		...
		description:
			"Choose from a variety of templates to create a README that fits your project's style and requirements.",
	},
	{
		imageSrc: "/icons/eye-care.png",
		title: "Live Markdown Preview",
		description:
			"See your README as you build it, with real-time markdown preview that keeps your formatting on point.",
	},
	{
		imageSrc: "/icons/colors.png",
		title: "Theme Customization",
		description:
			"Switch between dark, light, GitHub, and Bitbucket themes to see exactly how your README will look.",
	},
	{
		imageSrc: "/icons/features.png",
		title: "More features",
		description:
			"Enhance your README with embedded visuals, convenient export options, and comprehensive markdown formatting tools.",
	},
];
