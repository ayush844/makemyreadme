          ...
          <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
            ...
            <div className="m-auto mt-16 w-10/12 space-y-6 text-center sm:mt-auto sm:w-5/12 sm:text-left">
              <span className="block text-gray-400">
                <span className=' text-white font-bold'>By developers, For developers.</span><br /> We understand your needs and are here to help showcase your projects with style.
              </span>
              <span className="blocktext-gray-400">
                HAWKEYE-10844 &copy; <span id="year">{new Date().getFullYear()}</span>
              </span>
